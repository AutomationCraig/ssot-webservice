...
public class zzzzzzMyWebServiceTest {

//	@Deployment(testable = false) // testable = false to run as a client
//	public static WebArchive createDeployment() {
//		return ShrinkWrap.create(WebArchive.class, "ssot-webservice.war")
//				.addClasses(MyWebService.class).addClasses(TestCase.class)
...
//
//    @ArquillianResource
//    private URL baseContext; // http://localhost:8080/ssot-webservice/
//	
//	@Before
...
//		// expect
//
//		Project playerWith0Friends = TestUtils.getPlayer(baseContext, 1000);
//		Project playerWith1Friends = TestUtils.getPlayer(baseContext, 1001);
//		Project playerWith4Friends = TestUtils.getPlayer(baseContext, 1004);
//		Project playerWith5Friends = TestUtils.getPlayer(baseContext, 1005);
//		Project playerWith10Friends = TestUtils.getPlayer(baseContext, 1010);
//
...
//		TestCase twoFriend = TestUtils.getUser(baseContext, playerWith5Friends.getFriendList()
//				.get(1));
...
//	}
//    
//	private boolean isValidGameLinkLists(String HrefBeginning, Project player){
...
//			
//			TestCase curUser = TestUtils.getUser(baseContext, Long.valueOf(friendID));
//			if(curUser==null){
...
//	}
//	
//	public boolean userNameInList(TestCase user, ArrayList<String> friendNamesList){
